...
function StatBlock({
  ...
  return (
    ...
    >
      <span
        className="absolute left-0 top-6 h-12 w-1 rounded-r-full bg-[var(--accent-bar)] opacity-0 transition-opacity group-hover:opacity-100"
        aria-hidden
      />
      ...
      <p className="mt-2 text-sm font-medium text-[#2a2a2a]/70 dark:text-gray-300">
        {label}
      </p>
    </motion.div>
  );
...
export function StatsSection() {
  const stats = [
    ...
    { value: 5, suffix: "+", label: "Clients trusted us" },
      ...
      <div className="container-narrow">
        <header className="mb-8">
          ...
          <div className="section-header">
            <h2
              id="stats-heading"
              className="section-title font-display text-3xl font-bold tracking-tight text-[#2a2a2a] dark:text-white md:text-4xl md:leading-[1.2]"
            >
              By the numbers
            </h2>
          </div>
