...
function StatBlock({
  ...
  return (
    <motion.div
      ...
      className="stat-card group relative rounded-2xl border border-[#e8e8e8] bg-white p-6 pl-7 shadow-soft transition-all hover:border-[var(--accent-bar)]/20 hover:shadow-soft-lg"
    >
      ...
      <p className="mt-2 text-sm font-medium text-[#2a2a2a]/70">{label}</p>
    </motion.div>
  );
}
...
export function StatsSection() {
  const stats = [
    ...
    { value: 20, suffix: '+', label: 'Clients trusted us' },
    { value: 5, suffix: '+', label: 'Years experience' },
  ];

  return (
    <section className="section-padding border-t border-[#e8e8e8] bg-white" aria-labelledby="stats-heading">
      <div className="container-narrow">
        <header className="mb-8">
          ...
          <div className="section-header">
            <h2 id="stats-heading" className="section-title font-display text-3xl font-bold tracking-tight text-[#2a2a2a] md:text-4xl md:leading-[1.2]">
              By the numbers
            </h2>
          </div>
        </header>
